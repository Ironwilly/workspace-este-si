...
public class Principal {
	...
	public static void main(String[] args) {
		...
		Figura f1 = new Cuadrado("Segundo cuadrado", "verde", 2.0); // en este caso se instancia la figura como un
																	// cuadrado, esto unicamente se puede hacer dentro
																	// de la jerarquia de clases
		Figura f2 = new Circulo("Segundo círculo", "Amarillo", 2.0);// en este caso se instancia la figura como un
																	// circulo, esto unicamente se puede hacer dentro de
		...
		// System.out.println(f1.mostrarLados ()); Error de compilación --> hay q castearlo
		// System.out.println(f2.contarRadianes ());Error de compilación  --> hay q castearlo

		System.out.println("*******************************************************");
		System.out.println("*******Vamos ahora con el array de objetos**********\n\n");

		// Prueba con array de objetos.... esto en verdad va arriba del todo,junto con la declaracion de variables como siempre
